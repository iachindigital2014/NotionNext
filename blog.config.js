...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Iachin Digital', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Iachin Digital  | CD Keys,Software,Cursos,Ebooks,Audiolibros; More! ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://iachindigital.1919810.com', // 网站地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Iachin Digital ', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || 'https://iachindigital.1919810.com/', // 站点描述，被notion中的页面描述覆盖
